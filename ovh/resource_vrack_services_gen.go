	...
	attrs := map[string]schema.Attribute{
		...
		"current_tasks": schema.ListNestedAttribute{
			NestedObject: schema.NestedAttributeObject{
				...
				CustomType: VrackServicesCurrentTasksType{
					ObjectType: types.ObjectType{
						AttrTypes: VrackServicesCurrentTasksValue{}.AttributeTypes(ctx),
					},
				},
			},
			CustomType:          ovhtypes.NewTfListNestedType[VrackServicesCurrentTasksValue](ctx),
			Computed:            true,
...
type VrackServicesModel struct {
	...
	CurrentTasks   ovhtypes.TfListNestedValue[VrackServicesCurrentTasksValue] `tfsdk:"current_tasks" json:"currentTasks"`
...
func (v *VrackServicesModel) MergeWith(other *VrackServicesModel, overrideChecksum bool) {
	if overrideChecksum {
	...
	if (v.CurrentTasks.IsUnknown() || v.CurrentTasks.IsNull()) && !other.CurrentTasks.IsUnknown() {
		...
		if len(elems) != len(newElems) {
			...
			for idx, e := range elems {
				tmp := e.(VrackServicesCurrentTasksValue)
				tmp2 := newElems[idx].(VrackServicesCurrentTasksValue)
				tmp.MergeWith(&tmp2)
				newSlice = append(newSlice, tmp)
			}

			v.CurrentTasks = ovhtypes.TfListNestedValue[VrackServicesCurrentTasksValue]{
				ListValue: basetypes.NewListValueMust(VrackServicesCurrentTasksValue{}.Type(context.Background()), newSlice),
			}
		}
	}
...
type VrackServicesWritableModel struct {
	...
	TargetSpec *VrackServicesTargetSpecWritableValue `tfsdk:"target_spec" json:"targetSpec,omitempty"`
}
...
var _ basetypes.ObjectTypable = VrackServicesCurrentStateType{}

type VrackServicesCurrentStateType struct {
	basetypes.ObjectType
}

func (t VrackServicesCurrentStateType) Equal(o attr.Type) bool {
	other, ok := o.(VrackServicesCurrentStateType)
...
func (t VrackServicesCurrentStateType) String() string {
	return "VrackServicesCurrentStateType"
}

func (t VrackServicesCurrentStateType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	return VrackServicesCurrentStateValue{
...
func NewVrackServicesCurrentStateValueNull() VrackServicesCurrentStateValue {
	return VrackServicesCurrentStateValue{
		state: attr.ValueStateNull,
	}
}

func NewVrackServicesCurrentStateValueUnknown() VrackServicesCurrentStateValue {
	return VrackServicesCurrentStateValue{
		state: attr.ValueStateUnknown,
	}
}

func NewVrackServicesCurrentStateValue(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) (VrackServicesCurrentStateValue, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	for name, attributeType := range attributeTypes {
		...
		if !ok {
			diags.AddError(
				"Missing VrackServicesCurrentStateValue Attribute Value",
				"While creating a VrackServicesCurrentStateValue value, a missing attribute value was detected. "+
					"A VrackServicesCurrentStateValue must contain values for all attributes, even if null or unknown. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("VrackServicesCurrentStateValue Attribute Name (%s) Expected Type: %s", name, attributeType.String()),
			)
		...
		if !attributeType.Equal(attribute.Type(ctx)) {
			diags.AddError(
				"Invalid VrackServicesCurrentStateValue Attribute Type",
				"While creating a VrackServicesCurrentStateValue value, an invalid attribute value was detected. "+
					"A VrackServicesCurrentStateValue must use a matching attribute type for the value. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("VrackServicesCurrentStateValue Attribute Name (%s) Expected Type: %s\n", name, attributeType.String())+
					fmt.Sprintf("VrackServicesCurrentStateValue Attribute Name (%s) Given Type: %s", name, attribute.Type(ctx)),
			)
		}
	}
	...
	for name := range attributes {
		...
		if !ok {
			diags.AddError(
				"Extra VrackServicesCurrentStateValue Attribute Value",
				"While creating a VrackServicesCurrentStateValue value, an extra attribute value was detected. "+
					"A VrackServicesCurrentStateValue must not contain values beyond the expected attribute types. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("Extra VrackServicesCurrentStateValue Attribute Name: %s", name),
			)
		}
	}

	if diags.HasError() {
		return NewVrackServicesCurrentStateValueUnknown(), diags
	}
...
func NewVrackServicesCurrentStateValueMust(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) VrackServicesCurrentStateValue {
	object, diags := NewVrackServicesCurrentStateValue(attributeTypes, attributes)
	...
	if diags.HasError() {
		...
		panic("NewVrackServicesCurrentStateValueMust received error(s): " + strings.Join(diagsStrings, "\n"))
	}

	return object
}

func (t VrackServicesCurrentStateType) ValueFromTerraform(ctx context.Context, in tftypes.Value) (attr.Value, error) {
	if in.Type() == nil {
		return NewVrackServicesCurrentStateValueNull(), nil
	}
	...
	if !in.IsKnown() {
		return NewVrackServicesCurrentStateValueUnknown(), nil
	}
	...
	return NewVrackServicesCurrentStateValueMust(VrackServicesCurrentStateValue{}.AttributeTypes(ctx), attributes), nil
}

func (t VrackServicesCurrentStateType) ValueType(ctx context.Context) attr.Value {
	return VrackServicesCurrentStateValue{}
}

var _ basetypes.ObjectValuable = VrackServicesCurrentStateValue{}

type VrackServicesCurrentStateValue struct {
...
func (v *VrackServicesCurrentStateValue) UnmarshalJSON(data []byte) error {
	type JsonVrackServicesCurrentStateValue VrackServicesCurrentStateValue

	var tmp JsonVrackServicesCurrentStateValue
...
func (v VrackServicesCurrentStateValue) Attributes() map[string]attr.Value {
...
func (v VrackServicesCurrentStateValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
...
func (v VrackServicesCurrentStateValue) IsNull() bool {
	return v.state == attr.ValueStateNull
}

func (v VrackServicesCurrentStateValue) IsUnknown() bool {
	return v.state == attr.ValueStateUnknown
}

func (v VrackServicesCurrentStateValue) String() string {
	return "VrackServicesCurrentStateValue"
}

func (v VrackServicesCurrentStateValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (v VrackServicesCurrentStateValue) Equal(o attr.Value) bool {
	other, ok := o.(VrackServicesCurrentStateValue)
...
func (v VrackServicesCurrentStateValue) Type(ctx context.Context) attr.Type {
	return VrackServicesCurrentStateType{
		basetypes.ObjectType{
...
func (v VrackServicesCurrentStateValue) AttributeTypes(ctx context.Context) map[string]attr.Type {
...
var _ basetypes.ObjectTypable = VrackServicesCurrentTasksType{}

type VrackServicesCurrentTasksType struct {
	basetypes.ObjectType
}

func (t VrackServicesCurrentTasksType) Equal(o attr.Type) bool {
	other, ok := o.(VrackServicesCurrentTasksType)
...
func (t VrackServicesCurrentTasksType) String() string {
	return "VrackServicesCurrentTasksType"
}

func (t VrackServicesCurrentTasksType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	return VrackServicesCurrentTasksValue{
		Id:                            idVal,
		Link:                          linkVal,
		Status:                        statusVal,
		VrackServicesCurrentTasksType: typeVal,
		state:                         attr.ValueStateKnown,
	}, diags
}

func NewVrackServicesCurrentTasksValueNull() VrackServicesCurrentTasksValue {
	return VrackServicesCurrentTasksValue{
		state: attr.ValueStateNull,
	}
}

func NewVrackServicesCurrentTasksValueUnknown() VrackServicesCurrentTasksValue {
	return VrackServicesCurrentTasksValue{
		state: attr.ValueStateUnknown,
	}
}

func NewVrackServicesCurrentTasksValue(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) (VrackServicesCurrentTasksValue, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	for name, attributeType := range attributeTypes {
		...
		if !ok {
			diags.AddError(
				"Missing VrackServicesCurrentTasksValue Attribute Value",
				"While creating a VrackServicesCurrentTasksValue value, a missing attribute value was detected. "+
					"A VrackServicesCurrentTasksValue must contain values for all attributes, even if null or unknown. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("VrackServicesCurrentTasksValue Attribute Name (%s) Expected Type: %s", name, attributeType.String()),
			)
		...
		if !attributeType.Equal(attribute.Type(ctx)) {
			diags.AddError(
				"Invalid VrackServicesCurrentTasksValue Attribute Type",
				"While creating a VrackServicesCurrentTasksValue value, an invalid attribute value was detected. "+
					"A VrackServicesCurrentTasksValue must use a matching attribute type for the value. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("VrackServicesCurrentTasksValue Attribute Name (%s) Expected Type: %s\n", name, attributeType.String())+
					fmt.Sprintf("VrackServicesCurrentTasksValue Attribute Name (%s) Given Type: %s", name, attribute.Type(ctx)),
			)
		}
	}
	...
	for name := range attributes {
		...
		if !ok {
			diags.AddError(
				"Extra VrackServicesCurrentTasksValue Attribute Value",
				"While creating a VrackServicesCurrentTasksValue value, an extra attribute value was detected. "+
					"A VrackServicesCurrentTasksValue must not contain values beyond the expected attribute types. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("Extra VrackServicesCurrentTasksValue Attribute Name: %s", name),
			)
		}
	}

	if diags.HasError() {
		return NewVrackServicesCurrentTasksValueUnknown(), diags
	}
...
func NewVrackServicesCurrentTasksValueMust(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) VrackServicesCurrentTasksValue {
	object, diags := NewVrackServicesCurrentTasksValue(attributeTypes, attributes)
	...
	if diags.HasError() {
		...
		panic("NewVrackServicesCurrentTasksValueMust received error(s): " + strings.Join(diagsStrings, "\n"))
	}

	return object
}

func (t VrackServicesCurrentTasksType) ValueFromTerraform(ctx context.Context, in tftypes.Value) (attr.Value, error) {
	if in.Type() == nil {
		return NewVrackServicesCurrentTasksValueNull(), nil
	}
	...
	if !in.IsKnown() {
		return NewVrackServicesCurrentTasksValueUnknown(), nil
	}
	...
	return NewVrackServicesCurrentTasksValueMust(VrackServicesCurrentTasksValue{}.AttributeTypes(ctx), attributes), nil
}

func (t VrackServicesCurrentTasksType) ValueType(ctx context.Context) attr.Value {
	return VrackServicesCurrentTasksValue{}
}

var _ basetypes.ObjectValuable = VrackServicesCurrentTasksValue{}

type VrackServicesCurrentTasksValue struct {
	Id                            ovhtypes.TfStringValue `tfsdk:"id" json:"id"`
	Link                          ovhtypes.TfStringValue `tfsdk:"link" json:"link"`
	Status                        ovhtypes.TfStringValue `tfsdk:"status" json:"status"`
	VrackServicesCurrentTasksType ovhtypes.TfStringValue `tfsdk:"type" json:"type"`
	state                         attr.ValueState
}

func (v *VrackServicesCurrentTasksValue) UnmarshalJSON(data []byte) error {
	type JsonVrackServicesCurrentTasksValue VrackServicesCurrentTasksValue

	var tmp JsonVrackServicesCurrentTasksValue
	if err := json.Unmarshal(data, &tmp); err != nil {
		return err
	}
	v.Id = tmp.Id
	v.Link = tmp.Link
	v.Status = tmp.Status
	v.VrackServicesCurrentTasksType = tmp.VrackServicesCurrentTasksType
...
func (v *VrackServicesCurrentTasksValue) MergeWith(other *VrackServicesCurrentTasksValue) {
	...
	if (v.VrackServicesCurrentTasksType.IsUnknown() || v.VrackServicesCurrentTasksType.IsNull()) && !other.VrackServicesCurrentTasksType.IsUnknown() {
		v.VrackServicesCurrentTasksType = other.VrackServicesCurrentTasksType
	}
...
func (v VrackServicesCurrentTasksValue) Attributes() map[string]attr.Value {
	return map[string]attr.Value{
		"id":     v.Id,
		"link":   v.Link,
		"status": v.Status,
		"type":   v.VrackServicesCurrentTasksType,
	}
}
func (v VrackServicesCurrentTasksValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	attrTypes := make(map[string]tftypes.Type, 4)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.VrackServicesCurrentTasksType.ToTerraformValue(ctx)
...
func (v VrackServicesCurrentTasksValue) IsNull() bool {
	return v.state == attr.ValueStateNull
}

func (v VrackServicesCurrentTasksValue) IsUnknown() bool {
	return v.state == attr.ValueStateUnknown
}

func (v VrackServicesCurrentTasksValue) String() string {
	return "VrackServicesCurrentTasksValue"
}

func (v VrackServicesCurrentTasksValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (v VrackServicesCurrentTasksValue) Equal(o attr.Value) bool {
	other, ok := o.(VrackServicesCurrentTasksValue)
	...
	if !v.VrackServicesCurrentTasksType.Equal(other.VrackServicesCurrentTasksType) {
		return false
	}
...
func (v VrackServicesCurrentTasksValue) Type(ctx context.Context) attr.Type {
	return VrackServicesCurrentTasksType{
		basetypes.ObjectType{
			AttrTypes: v.AttributeTypes(ctx),
		},
...
func (v VrackServicesCurrentTasksValue) AttributeTypes(ctx context.Context) map[string]attr.Type {
	return map[string]attr.Type{
		"id":     ovhtypes.TfStringType{},
		"link":   ovhtypes.TfStringType{},
		"status": ovhtypes.TfStringType{},
...
var _ basetypes.ObjectTypable = VrackServicesTargetSpecType{}

type VrackServicesTargetSpecType struct {
	basetypes.ObjectType
}

func (t VrackServicesTargetSpecType) Equal(o attr.Type) bool {
	other, ok := o.(VrackServicesTargetSpecType)
...
func (t VrackServicesTargetSpecType) String() string {
	return "VrackServicesTargetSpecType"
}

func (t VrackServicesTargetSpecType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func NewVrackServicesTargetSpecValueNull() VrackServicesTargetSpecValue {
	return VrackServicesTargetSpecValue{
		state: attr.ValueStateNull,
	}
}

func NewVrackServicesTargetSpecValueUnknown() VrackServicesTargetSpecValue {
	return VrackServicesTargetSpecValue{
		state: attr.ValueStateUnknown,
	}
}

func NewVrackServicesTargetSpecValue(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) (VrackServicesTargetSpecValue, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	for name, attributeType := range attributeTypes {
		...
		if !ok {
			diags.AddError(
				"Missing VrackServicesTargetSpecValue Attribute Value",
				"While creating a VrackServicesTargetSpecValue value, a missing attribute value was detected. "+
					"A VrackServicesTargetSpecValue must contain values for all attributes, even if null or unknown. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("VrackServicesTargetSpecValue Attribute Name (%s) Expected Type: %s", name, attributeType.String()),
			)
		...
		if !attributeType.Equal(attribute.Type(ctx)) {
			diags.AddError(
				"Invalid VrackServicesTargetSpecValue Attribute Type",
				"While creating a VrackServicesTargetSpecValue value, an invalid attribute value was detected. "+
					"A VrackServicesTargetSpecValue must use a matching attribute type for the value. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("VrackServicesTargetSpecValue Attribute Name (%s) Expected Type: %s\n", name, attributeType.String())+
					fmt.Sprintf("VrackServicesTargetSpecValue Attribute Name (%s) Given Type: %s", name, attribute.Type(ctx)),
			)
		}
	}
	...
	for name := range attributes {
		...
		if !ok {
			diags.AddError(
				"Extra VrackServicesTargetSpecValue Attribute Value",
				"While creating a VrackServicesTargetSpecValue value, an extra attribute value was detected. "+
					"A VrackServicesTargetSpecValue must not contain values beyond the expected attribute types. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("Extra VrackServicesTargetSpecValue Attribute Name: %s", name),
			)
		}
	}

	if diags.HasError() {
		return NewVrackServicesTargetSpecValueUnknown(), diags
	}
...
func NewVrackServicesTargetSpecValueMust(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) VrackServicesTargetSpecValue {
	object, diags := NewVrackServicesTargetSpecValue(attributeTypes, attributes)
	...
	if diags.HasError() {
		...
		panic("NewVrackServicesTargetSpecValueMust received error(s): " + strings.Join(diagsStrings, "\n"))
	}

	return object
}

func (t VrackServicesTargetSpecType) ValueFromTerraform(ctx context.Context, in tftypes.Value) (attr.Value, error) {
	if in.Type() == nil {
		return NewVrackServicesTargetSpecValueNull(), nil
	}
	...
	if !in.IsKnown() {
		return NewVrackServicesTargetSpecValueUnknown(), nil
	}
	...
	return NewVrackServicesTargetSpecValueMust(VrackServicesTargetSpecValue{}.AttributeTypes(ctx), attributes), nil
}

func (t VrackServicesTargetSpecType) ValueType(ctx context.Context) attr.Value {
	return VrackServicesTargetSpecValue{}
}

var _ basetypes.ObjectValuable = VrackServicesTargetSpecValue{}

type VrackServicesTargetSpecValue struct {
	Subnets ovhtypes.TfListNestedValue[TargetSpecSubnetsValue] `tfsdk:"subnets" json:"subnets"`
	state   attr.ValueState
}

type VrackServicesTargetSpecWritableValue struct {
	*VrackServicesTargetSpecValue `json:"-"`
	Subnets                       *ovhtypes.TfListNestedValue[TargetSpecSubnetsValue] `json:"subnets,omitempty"`
}

func (v VrackServicesTargetSpecValue) ToCreate() *VrackServicesTargetSpecWritableValue {
	res := &VrackServicesTargetSpecWritableValue{}
...
func (v VrackServicesTargetSpecValue) ToUpdate() *VrackServicesTargetSpecWritableValue {
	res := &VrackServicesTargetSpecWritableValue{}
...
func (v *VrackServicesTargetSpecValue) UnmarshalJSON(data []byte) error {
	type JsonVrackServicesTargetSpecValue VrackServicesTargetSpecValue

	var tmp JsonVrackServicesTargetSpecValue
	if err := json.Unmarshal(data, &tmp); err != nil {
		return err
	}
	v.Subnets = tmp.Subnets
...
func (v *VrackServicesTargetSpecValue) MergeWith(other *VrackServicesTargetSpecValue) {
...
func (v VrackServicesTargetSpecValue) Attributes() map[string]attr.Value {
	return map[string]attr.Value{
		"subnets": v.Subnets,
	}
}
func (v VrackServicesTargetSpecValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	attrTypes := make(map[string]tftypes.Type, 2)
...
func (v VrackServicesTargetSpecValue) IsNull() bool {
	return v.state == attr.ValueStateNull
}

func (v VrackServicesTargetSpecValue) IsUnknown() bool {
	return v.state == attr.ValueStateUnknown
}

func (v VrackServicesTargetSpecValue) String() string {
	return "VrackServicesTargetSpecValue"
}

func (v VrackServicesTargetSpecValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (v VrackServicesTargetSpecValue) Equal(o attr.Value) bool {
	other, ok := o.(VrackServicesTargetSpecValue)
...
func (v VrackServicesTargetSpecValue) Type(ctx context.Context) attr.Type {
	return VrackServicesTargetSpecType{
		basetypes.ObjectType{
			AttrTypes: v.AttributeTypes(ctx),
		},
...
func (v VrackServicesTargetSpecValue) AttributeTypes(ctx context.Context) map[string]attr.Type {
	return map[string]attr.Type{
		"subnets": ovhtypes.NewTfListNestedType[TargetSpecSubnetsValue](ctx),
	}
}
