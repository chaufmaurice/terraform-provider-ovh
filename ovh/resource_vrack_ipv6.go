...
func resourceVrackIpv6ImportState(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
	...
	if err := setBridgedSubrange(d, meta, serviceName, block); err != nil {
		return nil, err
	}
...
func resourceVrackIpv6Read(d *schema.ResourceData, meta interface{}) error {
	...
	return setBridgedSubrange(d, meta, serviceName, block)
}
...
// setBridgedSubrange set the values of the BridgedSubrange nested resource in the state.
func setBridgedSubrange(d *schema.ResourceData, meta interface{}, serviceName, block string) error {
	config := meta.(*Config)
